...
func Bold(s string) string   { return defaultColorizer().Bold(s) }
func Green(s string) string  { return defaultColorizer().Green(s) }
func Red(s string) string    { return defaultColorizer().Red(s) }
func Yellow(s string) string { return defaultColorizer().Yellow(s) }
func Gray(s string) string   { return defaultColorizer().Gray(s) }
